# Creative & Art 3D Projects / Личные 3D проекты и арт

A gallery of personal works for the soul, perfect for practicing complex hard-surface modeling skills, working with light and textures.

Галерея личных работ для души, отработки навыков сложного hard-surface моделирования, работы со светом и текстурами.
